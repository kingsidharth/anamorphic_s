      ...
      <div id="content" role="main">
        ...
        <article id="post-0" class="post not-found">
          ...
          <div class="entry-content">
            ...
            <?php if ( anamorhpic_categorized_blog() ) : // Only show the widget if site has multiple categories. ?>
            <div class="widget widget_categories">
              <h2 class="widgettitle"><?php _e( 'Most Used Categories', 'anamorhpic' ); ?></h2>
              <ul>
              <?php
            ...
            $archive_content = '<p>' . sprintf( __( 'Try looking in the monthly archives. %1$s', 'anamorhpic' ), convert_smilies( ':)' ) ) . '</p>';
